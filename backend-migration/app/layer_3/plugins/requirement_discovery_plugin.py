...
class RequirementDiscoveryPlugin(BasePlugin):
    name = "requirement-discovery-plugin"
    ...
    def discover_requirement_urls_from_state(
        ...
        branches = self._branches_from_state(state_data)
        ...
        if platform == "gitlab":
            return self._discover_software_requirement_urls(
                owner,
                repo,
    ...
    def _branches_from_state(self, state_data: dict[str, Any]) -> tuple[str, ...]:
